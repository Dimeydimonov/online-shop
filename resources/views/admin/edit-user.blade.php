	...
	<div class="container">
		...
		<form action="{{ route('admin.users.update', $user->id) }}" method="POST">
			...
			<table class="table table-bordered">
				...
				<tr>
					<th>Фамилия</th>
					<td><input type="text" name="last_name" class="form-control" value="{{ $user->last_name }}"
							   required></td>
				</tr>
				<tr>
					<th>Отчество</th>
					<td><input type="text" name="patronymic" class="form-control" value="{{ $user->patronymic }}"
							   required></td>
				</tr>
				<tr>
					<th>Email</th>
				...
				<tr>
					...
					<td><input type="checkbox" name="active"
							   class="form-check-input" {{ $user->active ? 'checked' : '' }}></td>
				</tr>
				<tr>
				...
				<tr>
					<th>Адрес</th>
					<td><input type="text" name="address" class="form-control" value="{{ $user->address }}" required>
					</td>
				</tr>
				<tr>
					<th>Регион</th>
				...
				<tr>
					<th>Район</th>
					<td><input type="text" name="district" class="form-control" value="{{ $user->district }}" required>
					</td>
				</tr>
				<tr>
					<th>Населенный пункт</th>
					<td><input type="text" name="village" class="form-control" value="{{ $user->village }}" required>
					</td>
				</tr>
				<tr>
					<th>Адрес постового отделения</th>
					<td><input type="text" name="new_post_address" class="form-control"
							   value="{{ $user->new_post_address }}" required></td>
				</tr>
				<tr>
					<th>Создано</th>
